   ...
   class Queues
    {
        ...
        public void remove()
        {
            ...
            {
                /*If the element to be deleted is at the last position of the array, then value of FRONT is set to 0 i.e to the first element of the array. */
                FRONT = FRONT + 1;
            }
        }
        public void display()
        {
            ...
            {
                /*Traverses the queue till the last posotion of the array.*/
